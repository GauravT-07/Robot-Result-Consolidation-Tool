...
def merge_robot_results(src_folder, new_folder_path, merged_name):
...
merge_robot_results(
    ...
    new_folder_path=r"C:\\Users\\HP\\Desktop\\python_practice\\Robot-Result-Consolidation-Tool\\testdata\\merge_results",
